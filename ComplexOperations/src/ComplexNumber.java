public class ComplexNumber {
    ...
    /* A complex number is a number that can be expressed in the form a + bi, where a and b are real numbers, and i is
       a solution of the equation x*x = −1. Because no real number satisfies this equation, i is called an imaginary
       ...
       imaginary of type double. It represents the Complex Number. The class needs to have one constructor.
